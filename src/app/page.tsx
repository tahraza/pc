  ...
  return (
    <div className="min-h-screen">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-2 gap-4 md:grid-cols-4">
            <div className="text-center">
              ...
              <div className="text-sm text-slate-600">Leçons complètes</div>
            </div>
            <div className="text-center">
              <div className="text-3xl font-bold text-primary-600">{exercises.length}</div>
              <div className="text-sm text-slate-600">Exercices corrigés</div>
            </div>
            <div className="text-center">
            ...
            <div className="text-center">
              ...
              <div className="text-sm text-slate-600">Matières</div>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2 lg:grid-cols-3">
            ...
            <div className="card group hover:border-primary-200 hover:shadow-md transition-all">
            ...
            <div className="card group hover:border-primary-200 hover:shadow-md transition-all">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-cyan-100 text-cyan-600 group-hover:bg-cyan-600 group-hover:text-white transition-colors">
            ...
            {/* Feature 6: Parcours */}
            <div className="card group hover:border-primary-200 hover:shadow-md transition-all">
              <div className="flex h-12 w-12 items-center justify-center rounded-lg bg-rose-100 text-rose-600 group-hover:bg-rose-600 group-hover:text-white transition-colors">
      ...
      <section className="bg-slate-50 py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-slate-900">Deux matières complètes</h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
          ...
          <div className="mt-12 grid gap-8 md:grid-cols-2">
            ...
            <div className="card bg-gradient-to-br from-primary-50 to-white border-primary-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900">Physique</h3>
                  <p className="text-sm text-slate-600">{physiqueLessons.length} leçons disponibles</p>
                </div>
              </div>
            ...
            <div className="card bg-gradient-to-br from-emerald-50 to-white border-emerald-200">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="text-xl font-bold text-slate-900">Chimie</h3>
                  <p className="text-sm text-slate-600">{chimieLessons.length} leçons disponibles</p>
                </div>
              </div>
              <ul className="mt-6 space-y-2">
                <li className="flex items-center gap-2 text-sm text-slate-700">
              ...
              <Link
                ...
                className="mt-6 flex items-center gap-2 text-emerald-600 hover:text-emerald-700 font-medium"
              >
                Voir les leçons
                <ArrowRight className="h-4 w-4" />
              </Link>
      ...
      <section className="py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            <h2 className="text-3xl font-bold text-slate-900">La méthode des 5 passes</h2>
            <p className="mx-auto mt-4 max-w-2xl text-slate-600">
